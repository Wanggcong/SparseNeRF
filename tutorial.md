...
Please not that the depth map of your code. In some depth maps, large values denotes near (e.g., pre-trained depth estimation models output inverse depth maps). In this way, we use 
...
- Check if need to adjust the weight of depth loss, including depth ranking loss and continuity loss.
