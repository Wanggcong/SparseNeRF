...
- :white_check_mark: **[Use your dataset](https://github.com/Wanggcong/SparseNeRF/blob/main/tutorial.md)**: A tutorial on how to integrate SparseNeRF into **your own dataset**.
- :white_check_mark: **[Add it into your method]**: A tutorial on how to integrate SparseNeRF into your own method before September.
