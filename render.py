...
# from internal import configs, datasets_depth_llff_dtu, models, utils, vis  # pylint: disable=g-multiple-import
from internal import configs, datasets_depth_llff_dtu, datasets_depth_zed, datasets_depth_kinect, datasets_depth_iphone, math, models, utils, vis
import jax  
...
def main(unused_argv):
  ...
  if config.dataset_loader == 'dtu' or config.dataset_loader=='llff':  
    dataset = datasets_depth_llff_dtu.load_dataset('test', config.data_dir, config)
  ...
  if config.dataset_loader == 'dtu':
    ...
    eval_dict = {'fern': [0.059100067913532256, 0.8538959634304046],
                 ...
                 'scene01': [0.00022197533398866584, 0.9934533953666687],
                 'scene02': [0.00022197533398866584, 0.9934533953666687],
                 'scene03': [0.00022197533398866584, 0.9934533953666687],
                 'scene04': [0.00022197533398866584, 0.9934533953666687],
                 'scene05': [0.00022197533398866584, 0.9934533953666687],
                 'scene06': [0.00022197533398866584, 0.9934533953666687],
                 'scene07': [0.00022197533398866584, 0.9934533953666687],
                 'scene08': [0.00022197533398866584, 0.9934533953666687],                                 
  ...
  try:
    ...
    # state = checkpoints.restore_checkpoint(config.checkpoint_dir, state, step=30000)
  ...
  for idx in range(dataset.size):
    ...
    colorize_depth_map = True
    if colorize_depth_map:
